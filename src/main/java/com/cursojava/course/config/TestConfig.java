...
import com.cursojava.course.entities.Payment;
...
import com.cursojava.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Criando associações entre produtos e categorias
		...
		// Salvando novamente os produtos com as associações
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
		...
		//Adicionando os objetos depois de salvar os pedidos.
